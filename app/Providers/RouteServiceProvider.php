...
class RouteServiceProvider extends ServiceProvider
{
    ...
    /**
     * Define the "adventurer" routes for the application.
     *
     * These routes all receive session state, CSRF protection, etc.
     *
     * @return void
     */
    protected function mapAdventurerRoutes()
    {
        Route::group([
            'middleware' => ['web', 'adventurer', 'auth:adventurer'],
            'prefix' => 'adventurer',
            'as' => 'adventurer.',
            'namespace' => $this->namespace,
        ], function ($router) {
            require base_path('routes/adventurer.php');
        });
    }
